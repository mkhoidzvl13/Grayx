...
LoadButton.Image = "http://www.roblox.com/asset/?id=16723326511" --LOGO
...
page1:Toggle("AI Wallk To Ball",_G.AIWALK,function(value)
    _G.AIWALK = value
    game:GetService("StarterGui"):SetCore("SendNotification",{Title = "GrayxHub",Text = "Open When Game Start",Icon = "rbxassetid://16723326511",Duration = 1})
    ...
    page1:Toggle("Tự động đi về phía quả bóng",_G.AIWALK,function(value)
        _G.AIWALK = value
        game:GetService("StarterGui"):SetCore("SendNotification",{Title = "GrayxHub",Text = "địt mẹ vào trận rồi mở.",Icon = "rbxassetid://16723326511",Duration = 1})
        while _G.AIWALK do task.wait()
